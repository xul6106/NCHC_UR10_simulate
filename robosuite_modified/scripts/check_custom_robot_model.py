...
if __name__ == "__main__":
    ...
    parser.add_argument("--robot", type=str, default="UR10")
    parser.add_argument("--robot-xml-file", type=str, default="/home/xul6106/robosuite/robosuite/models/assets/robots/ur10/uur10.xml")
