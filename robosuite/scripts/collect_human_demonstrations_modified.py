...
def gather_demonstrations_as_hdf5(directory, out_dir, env_info):
    ...
    grp.attrs["env_args"] = env_info # "env_info"
...
if __name__ == "__main__":
    ...
    env = suite.make(
        **config,
        ...
        reward_shaping=True,
        control_freq=20,
        robot_init_qpos="left_ready"
    )

    # 在這裡加入 env_kwargs 到 config 字典，用於後續的 JSON 輸出
    config["env_kwargs"] = {
        "robots": args.robots,
        "has_renderer": True,
        "has_offscreen_renderer": False,
